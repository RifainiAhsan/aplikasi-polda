...
var
  Formpensiunan2: TFormpensiunan2;
  JPGku : TJPEGImage;
  asalscan : Integer;
...
uses
  Upensiunan3, Umenu, Upendaftaran;

{$R *.dfm}

procedure TFormpensiunan2.btn1Click(Sender: TObject);
begin
...
procedure TFormpensiunan2.btn2Click(Sender: TObject);
var
  sourceIndex : Integer;
  source : TTwainSource;
begin
...
procedure TFormpensiunan2.btn3Click(Sender: TObject);
begin
if vrtltbl1.IsEmpty then
...
procedure TFormpensiunan2.dlphtwn1TwainAcquire(Sender: TObject;
...
function TFormpensiunan2.NamaGambar: string;
begin
