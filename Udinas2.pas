...
procedure TForm_dinas2.btn1Click(Sender: TObject);
begin
...
procedure TForm_dinas2.btn2Click(Sender: TObject);
var
  sourceIndex : Integer;
  source : TTwainSource;
begin
...
procedure TForm_dinas2.btn3Click(Sender: TObject);
begin
if vrtltbl1.IsEmpty then
...
procedure TForm_dinas2.dlphtwn1TwainAcquire(Sender: TObject;
...
function TForm_dinas2.NamaGambar: string;
begin
