...
procedure TFormkaryawan3.DelFilesFrom(Directory, Filemask: string;
  DelSubDirs: Boolean);
...
function TFormkaryawan3.waktu: string;
var tgl : TDateTime;
begin
tgl:=Now();
...
procedure TFormkaryawan3.frxrprt1BeforePrint(Sender: TfrxReportComponent);
...
procedure TFormkaryawan3.FormShow(Sender: TObject);
begin
...
procedure TFormkaryawan3.btn1Click(Sender: TObject);
...
begin
  ...
  begin
    ...
    PDFku.FileName:= ExtractFilePath(Application.ExeName)+'\ARK\'+namapdf;
